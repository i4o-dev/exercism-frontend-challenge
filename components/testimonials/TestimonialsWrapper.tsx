...
export default function TestimonialsWrapper() {
	return (
		<div className='w-full px-8 flex flex-col items-center justify-center grow'>
			...
			<main className='w-full container mb-10 rounded-lg shadow-[0px_4px_42px_rgba(79,114,205,0.15)]'>
				<Header />
				<List />
				<Footer />
			</main>
